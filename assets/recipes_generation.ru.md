...
- 🎨 [**Демо генератора рецептов**](https://trekhleb.github.io/machine-learning-experiments/#/experiments/RecipeGenerationRNN) - позволяет сгенерировать новый рецепт прямо в браузере.
- 🏋🏻‍ [**Тренировка генератора рецептов**](https://github.com/trekhleb/machine-learning-experiments/blob/master/experiments/recipe_generation_rnn/recipe_generation_rnn.ipynb) - Jupyter ноутбук с деталями тренировки модели.
