...
- 🎨 [**Генератор рецептов: Демо**](https://trekhleb.github.io/machine-learning-experiments/#/experiments/RecipeGenerationRNN) - позволяет генерировать новый рецепт прямо в браузере.
